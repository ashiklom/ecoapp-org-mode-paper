...
The second tier involves metabolic traits---R_d, V_{c,max}, and J_max---which generally followed the leaf economic spectrum, but with a few notable deviations for specific PFTs and weaker covariance across PFTs.
...
but which showed systematic deviations from the leaf economic spectrum for many PFTs.

# TODO: Flesh this out (morphological, biochemical)
The consistent direction of relationships among SLA, N, and P is supported by ???.
{More refs}
{N:P ratio is conserved across PFTs}
That being said, it should be noted that although the direction of relationships among these three traits was consistent, the magnitude of their slopes showed non-trivial variation, particularly on a mass basis.
{Refs about SLA-N relationship?}

# TODO: Flesh this out (metabolic)
The less robust leaf economic spectrum signal in metabolic traits is likely a combination of two factors:
...
Water conservation strategy under water limitation cite:wright_2001_strategy
Varied N allocation to photosynthesis cite:ghimire_2017_global
Sample size limitation, especially for high-latitude PFTs (Tab.\ 1; Tab.\ S4).
All that being said, an important limitation to these results is the relative scarcity of metabolic trait measurements, especially for high-latitude PFTs.
Without more pairwise observations of these traits with other leaf traits, it is difficult to know exactly how much these are actual ecological patterns versus just artifacts of sampling bias.

# TODO: Flesh this out (longevity)
Leaf longevity...
