...
The subset of these processes operating on time-scales of centuries to millenia, such as evolution or turnover in soil carbon and nutrients,
may not be relevant for predicting how individual plants and ecosystems will respond to changes on policy-relevant timescals of months to decades.
...
# - cite:calow_1987_towards
# - cite:albert_2011_when
# - cite:box_1995_factors, cite:prentice_1992_special_paper
# - Refs from current PFT paragraph

The leaf economic spectrum has been investigated extensively at the global scale, where it is robust,
and at local scales (within species, and across similar species within the same ecosystem), where deviations from it are common.
However, a lot of ecosystem ecology involves plant functional types, groups of plant species with similar structural and functional characteristics that occupy similar bioclimatic niches cite:ustin_2010_remote.
Plant functional types are essential to many dynamic vegetation and earth system models cite:lavorel_1997_plant_functional_classifications,wullschleger_2014_plant,prentice_1992_special_paper.
However, they are also useful for ecology more broadly.

Meanwhile, grouping similar species into plant functional types with shared characteristics is widespread in ecological studies cite:naeem_2003_disentangling and is essential to many ecosystem models cite:lavorel_1997_plant_functional_classifications,wullschleger_2014_plant.

While the leaf economic spectrum has been investigated at the global scale, where
