...
The fact that trait relationships involving leaf lifespan showed the most scale dependence and within-PFT variability is not particularly surprising considering that leaf habit (deciduous vs.\ evergreen)---the largest driver of global variability in leaf lifespan---is a part of the PFT definition.
...
In summary, this suggests that, at the PFT-level, patterns of trait covariance associated with leaf lifespan are the most hierarchical.
