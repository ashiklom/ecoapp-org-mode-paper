...
# More general ecological thoughts about PFTs:
# Lastly, PFTs are defined such that the differences between them in terms of the abiotic environment (e.g. tropical, temperate, boreal) and structure
# Lastly, abiotic differences between the biomes underlying PFT definitions (e.g. tropical, temperate, and boreal)
#
# Lastly, PFTs are, by definition the product of regional- to global-scale environmental filters cite:box_1995_factors,prentice_1992_special_paper,
# as well as evolutionary discretization of traits like woodiness, leaf habit, and photosynthetic pathway on time scales far exceeding
# Lastly, the categorical traits typically used to define PFTs, namely woodiness, leaf habit, and photosynthetic pathway, are effectively fixed on sub-millennial timescales,
# and to a lesser extent the climate regions that are typically used to define PFTs
