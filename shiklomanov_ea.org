...
** Trait correlation patterns within- and across-PFTs
...
Within PFTs, slopes between SLA, $N_{mass}$, and $P_{mass}$ were consistently positive, and slopes of these traits with leaf lifespan were generally negative (though, for many PFTs, 95% credible intervals on correlations overlapped zero).
...
# TODO: Probably dropw this whole paragraph
...
#+CAPTION: Normalized mean root mean square error (RMSE) estimates from 5-fold cross-validation, by model and trait.
...
#+NAME: fig:rmse
[[../np-trait-analysis/figures/manuscript/n-fold-rmse.png]]
