...
Ultimately, our study reaffirms the value of studying not just individual traits but the multivariate trait space and the utility of hierarchical modeling for studying the scale dependence of trait relationships and for proposing, calibrating, and benchmarking PFT schemes.
...
All of these approaches benefit from developments in modelling and cyberinfrastructure that make it possible to more fluidly propose, calibrate, and benchmark PFTs cite:lebauer_2013_facilitating,dietze_2014_quantitative.
