...
n_both <- n_present %>%
  ...
  select(`Label` = label, `PFT` = pft, `# of Species`,
         leaf_lifespan, SLA,
...
Label & PFT & \# of Species & Leaf lifespan & SLA & N & P & Rd & Vcmax & Jmax & N & P & Rd & Vcmax & Jmax\\
\midrule
...
#+CAPTION: Sample sizes for each trait-PFT pair. $y$ axis is scaled logarithmically. Full PFT names are given in Table 1.
#+NAME: fig:samplesize
