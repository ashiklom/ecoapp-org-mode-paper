...
We have also replaced the 2 figures related to this topic from the previous draft with a single figure that, we hope, is easier to read and which better shows the major features of our results.
...
Thank you in advance for your consideration of this revised manuscript, and we look forward to your reply!
...
We have replaced this table, so this comment is no longer relevant.
