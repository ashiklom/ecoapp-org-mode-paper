...
We have added a simple power analysis of correlation coefficients to the "Methods: Analysis of Results".
...
We have replaced this statement in the revision.

#+begin_quote
385 See my concern: uncertainty != predictive error
#+end_quote

We have added a cross-validation analysis as you suggested (see earlier comments).
We have also clarified this sentence.
...
However, we have replaced this figure with a conceptually simpler one in the revision.
...
We have replaced this figure with a conceptually simpler one in the revision.
...
However, we have decided to keep the "lattice" layout.
...
No, but is important.
In the revision, we have an additional figure and analysis of the RMSE.
