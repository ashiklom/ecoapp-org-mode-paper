...
However, per the reviewer's next comment, this particular point was somewhat tangential to the aims of this manuscript, so we removed this sentence altogether.
