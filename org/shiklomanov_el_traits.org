...
#+LATEX_HEADER: \author[1]{Alexey N. Shiklomanov}
#+LATEX_HEADER: \author[2]{Elizabeth M. Cowdery}
#+LATEX_HEADER: \author[2]{Michael C. Dietze}
...
#+CSL_STYLE: /Users/shik544/Projects/tools/styles/ecology-letters.csl 

| Section               | Word count |
|-----------------------+------------|
| Abstract              |        191 |
| Introduction          |       1124 |
| Materials and methods |       2161 |
| Results               |       1266 |
| Discussion            |       1933 |
|-----------------------+------------|
| Total                 |       6675 |
...
We implemented this sampling algorithm in an open source, publicly available R cite:rstats package (<http://github.com/ashiklom/mvtraits>).
